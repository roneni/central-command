    ...
    <div className="h-full flex flex-col bg-bg-base overflow-y-auto">
      ...
      <div className="border-b border-bg-surface-hover px-8 py-5 flex items-center justify-between bg-bg-base z-10 sticky top-0">
        ...
        <div className="flex items-center space-x-3">
          <button className="flex items-center space-x-1.5 bg-bg-surface hover:bg-bg-surface-hover border border-bg-surface-active text-text-primary px-4 py-2 rounded-md font-medium transition-colors text-sm">
      ...
      <div className="p-8 max-w-7xl mx-auto w-full space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((card, i) => (
            <div key={i} className="bg-bg-surface border border-bg-surface-hover hover:border-bg-surface-active rounded-xl p-5 shadow-sm transition-colors group">
              <div className="flex items-center justify-between mb-4">
                <div className="p-2 bg-bg-base rounded-lg border border-bg-surface-hover text-text-secondary group-hover:text-text-primary transition-colors">
              ...
              <div className="flex items-end justify-between">
                ...
                <div className={`flex items-center space-x-1 text-sm font-medium ${card.type === 'positive' ? 'text-brand-green' : 'text-brand-red'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Main Chart Area */}
          <div className="lg:col-span-2 bg-bg-surface border border-bg-surface-hover rounded-xl p-6 shadow-sm min-h-[400px] flex flex-col">
            <div className="flex items-center justify-between mb-8">
              ...
              <select className="bg-bg-base border border-bg-surface-active text-text-secondary text-sm rounded-md px-3 py-1 outline-none">
            ...
            <div className="flex-1 flex items-end space-x-2 sm:space-x-4">
              ...
              {[40, 60, 30, 80, 50, 90, 70].map((height, i) => (
                <div key={i} className="flex-1 flex flex-col items-center group">
                  <div className="w-full relative flex items-end justify-center rounded-t-md overflow-hidden bg-bg-base" style={{ height: '300px' }}>
                    <div 
                    ...
                    ></div>
                    {/* Tooltip on hover */}
                    <div className="absolute opacity-0 group-hover:opacity-100 -top-8 bg-bg-surface-active text-text-primary text-xs py-1 px-2 rounded transition-opacity shadow-xl z-10 whitespace-nowrap">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-bg-surface border border-bg-surface-hover rounded-xl p-6 shadow-sm">
              <h2 className="text-lg font-semibold text-text-primary mb-6">Task Priority</h2>
              <div className="space-y-4">
                <div className="space-y-1">
                  <div className="flex justify-between text-sm">
                    <span className="text-brand-red font-medium">Urgent</span>
                    <span className="text-text-secondary">15%</span>
                  </div>
                  <div className="w-full bg-bg-base rounded-full h-2 overflow-hidden">
                    <div className="bg-brand-red h-full rounded-full" style={{ width: '15%' }}></div>
                  </div>
                </div>
                <div className="space-y-1">
                  <div className="flex justify-between text-sm">
            ...
            <div className="bg-bg-surface border border-bg-surface-hover rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-3">
                {[
                  { name: "AIA Agency", count: 4, color: "text-brand-purple" },
                  { name: "Tools & Products", count: 2, color: "text-brand-cyan" },
                  { name: "Psychedelic Universe", count: 1, color: "text-brand-green" }
                ].map((item, i) => (
                  <div key={i} className="flex items-center justify-between p-3 bg-bg-base rounded-lg border border-bg-surface-hover">
                    <div className="flex items-center space-x-3">
                      <div className={`w-8 h-8 rounded bg-bg-surface flex items-center justify-center ${item.color}`}>
