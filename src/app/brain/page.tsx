...
export default function BrainPage() {
  ...
  const suggestedActions = [
    { title: "Create Agent", icon: Bot, color: "text-brand-purple", bg: "bg-brand-purple/10" },
  ...
  return (
    <div className="flex flex-col h-full bg-bg-base">
      {/* Top Header */}
      <div className="border-b border-bg-surface-hover px-6 py-4 flex items-center justify-between">
        ...
        <div>
          <select className="bg-bg-surface border border-bg-surface-hover text-text-secondary text-sm rounded-md px-3 py-1.5 outline-none focus:border-brand-cyan">
      ...
      <div className="flex-1 overflow-y-auto p-6 md:p-12 flex flex-col items-center justify-center">
        ...
        <div className="max-w-2xl w-full text-center space-y-8">
          <div className="inline-block p-4 rounded-full bg-bg-surface shadow-xl border border-bg-surface-hover mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            {suggestedActions.map((action, i) => (
              <button key={i} className="flex flex-col items-center justify-center p-6 bg-bg-surface hover:bg-bg-surface-hover border border-bg-surface-hover hover:border-bg-surface-active rounded-xl transition-all group">
      ...
      {/* Input Area */}
      <div className="p-6 border-t border-bg-surface-hover bg-bg-base shrink-0">
        <div className="max-w-4xl mx-auto relative group">
          ...
          <input 
            ...
            className="w-full bg-bg-surface border border-bg-surface-hover text-text-primary rounded-xl pl-12 pr-24 py-4 shadow-sm focus:outline-none focus:border-brand-cyan focus:ring-1 focus:ring-brand-cyan transition-all"
          />
